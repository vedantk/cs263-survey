...
functions of [JM82]. This structure is defined in [SRW96] \footnote{As in
the previous section, we focus on the definitions in [SRW96] for clarity.}
as a finite digraph consisting of \textit{shape nodes}, \textit{variable
edges}, and \textit{selector edges}.
